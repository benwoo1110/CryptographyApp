...
namespace Cryptography.Core.Ciphers
{
    ...
    public class TwoFishNew : Cipher

    {
        ...
        {
            int bitLength = Utilities.NumberOfBits(num);
        ...
        private static int F32(int k64Cnt, int x, int[] k32)
        {
            ...
            int result = 0;
            int comparator = k64Cnt & 3;
            if (comparator == 1)
            {
                result =
                    MDS[0, (int) ((P[P_01, (int) b0] & 0xFF) ^ B0(k0))] ^
                    MDS[1, (int) ((P[P_11, (int) b1] & 0xFF) ^ B1(k0))] ^
                    MDS[2, (int) ((P[P_21, (int) b2] & 0xFF) ^ B2(k0))] ^
                    MDS[3, (int) ((P[P_31, (int) b3] & 0xFF) ^ B3(k0))];
            }
            if (comparator == 0)
            {
                b0 = (P[P_04, (int) b0] & 0xFF) ^ B0(k3);
                b1 = (P[P_14, (int) b1] & 0xFF) ^ B1(k3);
                b2 = (P[P_24, (int) b2] & 0xFF) ^ B2(k3);
                b3 = (P[P_34, (int) b3] & 0xFF) ^ B3(k3);
            }
            if (comparator == 0 || comparator == 3)
            {
                b0 = (P[P_03, (int) b0] & 0xFF) ^ B0(k2);
                b1 = (P[P_13, (int) b1] & 0xFF) ^ B1(k2);
                b2 = (P[P_23, (int) b2] & 0xFF) ^ B2(k2);
                b3 = (P[P_33, (int) b3] & 0xFF) ^ B3(k2);
            }
            if (comparator == 0 || comparator == 3 || comparator == 2)
            {
                result =
                    MDS[0, (int) ((P[P_01, (int) ((P[P_02, (int) b0] & 0xFF) ^ B0(k1))] & 0xFF) ^ B0(k0))] ^
                    MDS[1, (int) ((P[P_11, (int) ((P[P_12, (int) b1] & 0xFF) ^ B1(k1))] & 0xFF) ^ B1(k0))] ^
                    MDS[2, (int) ((P[P_21, (int) ((P[P_22, (int) b2] & 0xFF) ^ B2(k1))] & 0xFF) ^ B2(k0))] ^
                    MDS[3, (int) ((P[P_31, (int) ((P[P_32, (int) b3] & 0xFF) ^ B3(k1))] & 0xFF) ^ B3(k0))];
            }
        ...
        public static object MakeKey(BigInteger key)
        {
            ...
            for (i = 0; i < 256; i++)
            {
                ...
                if (comparator == 1)
                {
                    sBox[2 * i] = MDS[0, (int) ((P[P_01, (int) b0] & 0xFF) ^ B0(k0))];
                    sBox[2 * i + 1] = MDS[1, (int) ((P[P_11, (int) b1] & 0xFF) ^ B1(k0))];
                    sBox[0x200 + 2 * i] = MDS[2, (int) ((P[P_21, (int) b2] & 0xFF) ^ B2(k0))];
                    sBox[0x200 + 2 * i + 1] = MDS[3, (int) ((P[P_31, (int) b3] & 0xFF) ^ B3(k0))];
                }
                if (comparator == 0)
                {
                    b0 = (P[P_04, (int) b0] & 0xFF) ^ B0(k3);
                ...
                {
                    sBox[2 * i] = MDS[0,
                        (int) ((P[P_01, (int) ((P[P_02, (int) b0] & 0xFF) ^ B0(k1))] & 0xFF) ^ B0(k0))];
                    sBox[2 * i + 1] = MDS[1,
                        (int) ((P[P_11, (int) ((P[P_12, (int) b1] & 0xFF) ^ B1(k1))] & 0xFF) ^ B1(k0))];
                    sBox[0x200 + 2 * i] = MDS[2,
                        (int) ((P[P_21, (int) ((P[P_22, (int) b2] & 0xFF) ^ B2(k1))] & 0xFF) ^ B2(k0))];
                    sBox[0x200 + 2 * i + 1] = MDS[3,
                        (int) ((P[P_31, (int) ((P[P_32, (int) b3] & 0xFF) ^ B3(k1))] & 0xFF) ^ B3(k0))];
                }
            }
            ...
            {
                for (j = 0; j < 4; j++)
                    Console.Write("0x" + Utilities.ConvertToString(sBox[i * 4 + j], InputType.Hex) + ", ");
                Console.WriteLine();
            }
        ...
        private BigInteger BlockEncrypt(BigInteger input, int inOffset, object sessionKey)
        {
            ...
            // Split up input
            int x0 = (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) | 
            ...
            int x1 = (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) | 
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 8 | 
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 16 | 
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 24;
            int x2 = (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) | 
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 8 | 
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 16 | 
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 24;
            
            int x3 = (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) |
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 8 | 
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 16 | 
                     (GetByteAtPos(input, inOffset++, INPUT_LENGTH) & 0xFF) << 24;
            ...
            BigInteger result = toBigInt(answer);
        ...
        {
            PrecomputeMDSMatrix();
            /*BigInteger pt = (BigInteger) Utilities.ConvertToBigInt("000102030405060708090A0B0C0D0E0F");
            BigInteger key = (BigInteger) Utilities.ConvertToBigInt("000102030405060708090A0B0C0D0E0F1011121314151617");
            
            
            Object sessionKey = MakeKey(key);
            BigInteger ct = Encrypt(pt, key);
            BigInteger ptback = BlockDecrypt(ct, 0, sessionKey);
            
            Console.WriteLine($"CHECK ==== {ptback == pt}");*/
        }
